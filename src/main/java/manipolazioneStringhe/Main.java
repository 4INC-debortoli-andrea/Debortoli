...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String testo = "w ef sf e fsf sf eifnmwp";
        ...
        int indiceDa = testo.indexOf('a', 10);
        int indiceA = testo.lastIndexOf('e', 20);
        System.out.println("Indice della lettera inserita a partire dalla posizione 10: " + indiceDa);
        System.out.println("Ultimo indice della lettera inserita entro la posizione 20: " + indiceA);
